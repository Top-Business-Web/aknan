...
@section('content')
    ...
    @section('breadcrumb')
            <div class="mt-4">
                <h1 class="text-center text-light mb-3">{{ lang() == 'ar' ? 'اماكن المشاريع' : 'Project locations' }}</h1>
                <div class="d-flex justify-content-center content-landing">
                    ...
                    <span class="me-2">{{ lang() == 'ar' ? 'اماكن المشاريع' : 'Project locations' }}</span>
                </div>
            </div>
    @endsection
    ...
    <div class="section-contact pt-3">
        <div class="container-fluid">
            <div>
                <iframe src="{{ $setting->location_work }}" width="100%" height="600"></iframe>
            </div>
        </div>
    </div>
