    ...
    <form id="addForm" class="addForm" method="POST" enctype="multipart/form-data" action="{{route('job.store')}}">
        ...
        <div class="row">
            <div class="form-group col-12">
                ...
                <textarea type="text" class="form-control" name="desc_ar" id="name" required></textarea>
            </div>
            <div class="form-group col-12">
                <label for="name" class="form-control-label">المتطلبات بالانجليزية</label>
                <textarea type="text" class="form-control" name="desc_en" id="name" required></textarea>
            </div>
        </div>
